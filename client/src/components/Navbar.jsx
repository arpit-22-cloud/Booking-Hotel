...
const BookIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M5 19V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zmo 0a2 2 0 0 0 2 2h12M9 3v14M9 3v14m7 0v4 "
    />
  </svg>
);
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        ...
        {user && (
          <button
            ...
            onClick={() =>
              isOwner ? navigate("/owner") : setShowHotelRegistration(true)
            }
          >
